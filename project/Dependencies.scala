...
object Dependencies {
  ...
  lazy val json4sJackson = "org.json4s" %% "json4s-jackson" % "4.0.3" % Provided

  lazy val zioJson = "dev.zio" %% "zio-json" % "0.4.2" % Provided

  lazy val akkaHttp = "com.typesafe.akka" %% "akka-http" % "10.2.7" % Provided
  lazy val akkaHttpSocks5 = "io.github.rorp" %% "akka-http-socks5" % "10.2.7"
  lazy val akkaStreams = "com.typesafe.akka" %% "akka-stream" % "2.6.20" % Provided
